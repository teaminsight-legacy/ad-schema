...
module ActiveDirectory
  ...
  class OrganizationalPerson < ActiveDirectory::Person
    ...
    attributes :address, :home_address, :assistant, :company_name, :country_code, :country_name,
      :department, :division, :email, :employee_id, :fax_number, :generation_qualifier, :first_name,
      :initials, :locality_name, :manager, :organizational_unit, :other_mailbox, :middle_name
